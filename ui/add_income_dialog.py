from PyQt5.QtWidgets import (
    QDialog, QVBoxLayout, QLabel, QFrame, QLineEdit, QDateEdit, QComboBox,
    QDoubleSpinBox, QGridLayout, QTextEdit, QPushButton, QHBoxLayout, QSpacerItem, QSizePolicy
)
...
class AddIncomeDialog(QDialog):
    def __init__(self, on_submit_callback=None):
        ...
        form_grid.addWidget(QLabel("Source"), 0, 1)
        ...
        self.add_income_btn.clicked.connect(self.handle_add_income)
